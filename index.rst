.. streamcorpus-pipeline documentation master file, created by
   sphinx-quickstart on Thu Mar  6 17:19:40 2014.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to StreamCorpus
=======================
...
.. toctree::
   ...
   sphinx-docs/overview
   sphinx-docs/streamcorpus
   sphinx-docs/streamcorpus_pipeline
   sphinx-docs/yakonfig
   sphinx-docs/dblogger
   sphinx-docs/kvlayer
   sphinx-docs/rejester
